...
import (
	...
	"github.com/hasicorp/terraform/helper/resource"
)
	...
	resource.Test(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			resource.TestStep{
				...
				Check:  resource.ComposeTestCheckFunc(testAccDataflowJobExists("google_dataflow_job.big_data")),
			},
		},
	})
}
...
resource "google_dataflow_job" "big_data" {
  ...
  template_gcs_location = "${google_storage_bucket.temp.url}"
}
